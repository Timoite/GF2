...
Appreciation: This code is taken from the sample application provided in i18n for wxpython documentation.
Minor modifications will be made to suit the application.
