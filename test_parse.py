...
- Every recognized error in the network description
...
def parser_factory():
    ...
    def _create_parser(filename: str) -> Parser:
        ...
        file_path = os.path.join(base_dir, "GF2/test_files", filename)
...
def test_error_files_are_rejected(parser_factory,
                                  capsys, filename, expected_msg):
    """
